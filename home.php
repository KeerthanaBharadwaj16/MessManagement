...
<body style="background-image: url('home.jpg');">
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h3 class="display-4">Welcome! To JIT Mess!!</h3>
            <p class="lead">
                Here we intend to provide nutricious and quality food for the students living in the hostel .Started on this college has been running flawlesly so far ,so has been the hostels. There are three hostels with their three messes serving food to students since
                the college started.
            ...
            <div class="col-md-3 col-sm-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-center">Timing: 9:30AM - 10:30AM</p>
                        <hr>
            ...
            <div class="col-md-3 col-sm-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-center">Timing: 5:30PM - 6:15PM</p>
                        <hr>
    ...
    <div id="check" class="container">
        <div class="flex">
            <div class="menu-card" id="menucard-b">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title" style="text-align:center">Breakfast</h5>
                        <h6 class="card-subtitle text-muted" style="text-align:center">Choose 7 options for the menu</h6>
                        <hr>
    ...
    <div id="check" class="container">
        <div class="flex">
            <div class="menu-card" id="menucard-d">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title" style="text-align:center">Dinner</h5>
                        <h6 class="card-subtitle text-muted" style="text-align:center">Choose 7 options for the menu</h6>
                        <hr>
                        <form id="breakfast" name="breakfast" action="check.php" method="POST">
                            <div class="menu-items">
...
<div class="coloumn">
    ...
    <center><h4><b>Top 3 breakfast item</b></h4><hr></center>
    <?php 
  ...
  <div class="coloumn">
  <div class="card-t">
  <center><h4><b>Top 3 lunch item</b></h4><hr></center>
    <?php 
  ...
  <div class="coloumn">
  <div class="card-t">
  <center><h4><b>Top 3 snacks item</b></h4><hr></center>
    <?php 
  ...
  <div class="coloumn">
  <div class="card-t">
  <center><h4><b>Top 3 dinner item</b></h4><hr></center>
    <?php 
    ...
    <div>
        <footer class="page-footer bg-dark">
            <div>
                <p style="color:white" class="h6 text-center footer-copyright p-3">Made With<span style="color: deeppink">Love</span></p>
                <div class="contact-footer">
                    <span>Contact Us</span>
                    <span>Email : <a href="mailto:jitmess@gmail.com">jitmess@gmail.com</a> Phone number: <a href="tel:9620403128">9620403128</a></span>
                </div>
            </div>
        </footer>
    </div>
